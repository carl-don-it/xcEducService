...
<html lang="en">
	...
	<body>
		<div class="banner-roll">
            ...
            <#--都是原型数据，不要了，换成freemarker标签-->
            <#-- <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-bannerB.jpg);"></div>
             <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-bannerA.jpg);"></div>
             <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-banner3.png);"></div>
             <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-bannerB.jpg);"></div>
             <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-bannerA.jpg);"></div>
             <div class="item" style="background-image: publishUrl(http://www.xuecheng.com/img/widget-banner3.png);"></div>-->
        <#if model??>
